...
def add_location():
  ...
  return redirect(url_for('locations', category = category, _external = True, _scheme = "html"))

@app.route("/")
def index():

  ## Redirect to locations route function
  return redirect(url_for('locations', category  = 'recommended', _external = True, _scheme = "html" ))
